"""
Django settings for djmessenger_config project.
...
ROOT_URLCONF = 'djmessenger_config.urls'
...
WSGI_APPLICATION = 'djmessenger_config.wsgi.application'
...
if os.environ.get('DATABASE_URL', None):
    # If we are deploying in a 12factor PaaS, use its configuration.
